...
- However, before you start with various normality tests, keep in mind that when your sample is not normal it does not mean automatically that the undelying population is also non-normal

- There are several statistical tests for distributions, let's start with visual test - Q-Q plot
